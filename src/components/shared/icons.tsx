...
export const Icons = {
  ...
  square: SquareIcon,
  style: Sparkles,
  animation: SquareStack,
  fontStroke: SpellCheck,
  fontShadow: SpellCheck2,
  crop: Crop,
  shadow: GalleryThumbnails,
  outline: LaptopMinimal,
  basic: GalleryVertical,
  speed: ChevronsUp,
  ...
  elements: ({ ...props }: LucideProps) => (
    ...
    >
      <path
        d="M10.9 10.9V1H1V10.9M3.2 8.7V3.2H8.7V8.7M20.8 5.95C20.8 7.49 19.59 8.7 18.05 8.7C16.51 8.7 15.3 7.49 15.3 5.95C15.3 4.41 16.521 3.2 18.05 3.2C19.579 3.2 20.8 4.421 20.8 5.95ZM5.95 14.2L1 23H10.9M7.138 20.8H4.762L5.95 18.688M23 5.95C23 3.2 20.8 1 18.05 1C15.3 1 13.1 3.2 13.1 5.95C13.1 8.7 15.3 10.9 18.05 10.9C20.8 10.9 23 8.7 23 5.95ZM19.7 17.5V14.2H17.5V17.5H14.2V19.7H17.5V23H19.7V19.7H23V17.5H19.7Z"
        fill="currentColor"
      />
    </svg>
  ),
